    ...
    <div class="wrapper page-clients">
        ...
        <div class="middle nopadding-top" id="middle">
            ...
            <div class="team-wrapper">
                <div class="h1 title-block hide-pc">Our Team</div>
                <div class="team-block">
                    ...
                    <div class="team-list">
                        <div class="team-slider-full">
                            <?php foreach($team as $k => $item): ?>
                            <div id="team-<?= $k ?>" class="row-team flexbox full-height item-team-<?php echo $k ?>" style="background-image: url(<?php echo get_field('baner_image', $item->ID) ?>);">
