...
<body <?php body_class() ?>>
    <div class="wrapper single-client">
        <header id="site-header" class="header header-image full-height header-full case-header header-inner header-nocolor">
            ...
            <div class="header-bg" style="background-image: url(<?= get_field('baner', $post->ID) ?>)"></div>
                ...
                <div class="">
                    ...
                    <div class="content">
                        <div class="container">
                            <div class="row">
                                <div class="block-case col-md-8 col-md-offset-2">
                                    <div class="title-block-case h1">The Challenge</div>
                        ...
                        <div class="container">
                            <div class="row">                        
                                <div class="block-case col-md-8 col-md-offset-2">
                                    <div class="title-block-case h1">The Solutione</div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="block-case col-md-8 col-md-offset-2">
                                    <div class="title-block-case h1">The Architecture Overview</div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 col-md-offset-2">
                                            <div class="case-slider">
                                                <?php if($slides = get_field('product_ui')): foreach($slides as $item): ?>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="page-entry col-md-9 col-md-offset-2">
                                        <div class="h1 title-bracket">Summary</div>
