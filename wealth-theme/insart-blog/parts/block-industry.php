<section class="feautured-post" data-block="block-3">
        ...
        while ($_posts->have_posts()) : 
          ...
          $i++;
           if($i==4):
       ?>
       <div class="hidden-block hidden-feautured-post" id="hidden-industry-post">
      <?php endif; ?>
        <article>
          <header>
             <?php //the_post_thumbnail( array(320, 140))
             $img = get_field('image'); ?>
             <img src="<?php echo wp_get_attachment_image_url($img['id'], 'img_80_80') ?>" alt="<?php echo $img['alt'] ?>" class="circle-img">
