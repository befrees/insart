...
<html>
  <head>
    ...
    <link href='<?php bloginfo('template_url'); ?>/build/css/main.css' rel='stylesheet' type='text/css'>
  ...
  <main class="main post-main main-inner main-404" role="main">  
    <h1 class="post-inner__ttl">404 error</h1>
    
      <section class="content">
        <p>This webpage is not found</p>
    </section> 

    <a href="/" class="btn back-home long-shadow">Back home</a>
