...
<html>
  <head>
    ...
    <script src="<?php bloginfo('template_url'); ?>/client/js/jquery.flatshadow.js"></script>
  ...
  <div style="display: none;">
    ...
    <div class="container">
    <header class="header-front site-header header-blue">
      <div class="header">
        <div class="header__left">
          <a href="<?php echo get_home_url(); ?>" class="logo long-shadow">
            <img src="<?php bloginfo('template_url'); ?>/client/images/logo1.svg" alt="logo">
          </a>
        </div>
    ...
    <div class="promo__inner">
      ...
      <div class="wrap-menu-affix" data-uk-sticky="{media: 980}" >
        <div class="menu-affix-inner">
            <a href="/" class="logo-sticky">
              <img src="/wp-content/themes/insart-blog/client/images/logo.svg" height="20" width="20" alt="logo" />
            </a>
            <?php if($nav =  wp_get_nav_menu_items( 'top-cats' )): ?>
              <ul class="menu-sticky">
                <?php foreach($nav as $k => $li): ?>
                <li><a href="<?= $li->object == 'category' ? '/?c='. $li->object_id : '/' ?>" class="ajax-cat-link <?= $k===0 ? 'active' : '' ?>"><?= $li->title ?></a></li>
                <?php endforeach; ?>
              </ul>
            <?php endif; ?>
      <div class="form-controls controls-promo long-shadow">
  ...
  <div class="titles-header">
    <div class="title-header title-header-1">CTO Insights</div>
    <div class="title-header title-header-2">Club Swimlane</div>
    <div class="title-header title-header-3">Featured Articles</div>
  </div>
  </header>